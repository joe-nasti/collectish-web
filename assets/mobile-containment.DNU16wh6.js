(()=>{let e=`cxAdminSinglesMobileContainment`;if(!document.getElementById(e)){let t=document.createElement(`style`);t.id=e,t.textContent=`
    ...
    `,document.head.appendChild(t)}let t=()=>{let e=document.scrollingElement||document.documentElement;e&&(e.scrollLeft=0),document.documentElement.scrollLeft=0,document.body.scrollLeft=0},n=e=>{let n=e?e===`singles`:document.getElementById(`cxAdminConsole`)?.dataset.activeSection===`singles`;document.documentElement.classList.toggle(`cx-admin-singles-contained`,!!n),n&&(t(),requestAnimationFrame(t),setTimeout(t,80))};document.addEventListener(`collectish:admin-section-change`,e=>n(e.detail?.section)),document.addEventListener(`collectish:admin-modules-ready`,()=>n()),window.addEventListener(`resize`,()=>n()),n()})();